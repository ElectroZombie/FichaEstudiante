...
public class Editor_eventos extends AbstractFrame {
    ...
    @Override
    public void inputDialog_returnValue(Object O, int seleccion){
        opcionDevuelta1(O);
    }
    ...
    private void opcionDevuelta1(Object O){
        ...
        if (!Similares.isEmpty()) {
            ...
            ComboBoxDialog inputDialog = new ComboBoxDialog(2, "Existen eventos con nombres similares al del evento que ha escrito.\nSeleccione uno de ellos o pulse en cancelar si no se ha equivocado.", "Sugerencia", S, temp,Language.ES, this);
            ...
            MessageDialog messageDialog = new MessageDialog("El evento \"" + temp + "\" ha sido agregado satisfactoriamente.", "Mensaje del sistema",Language.ES, this);
    ...
    private void nuevoEventoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nuevoEventoMouseClicked
        ...
        InputDialog inputDialog = new InputDialog(1, "¿Desea agregar el evento?", "Mensaje del sistema", TextNombreEvento.getText(),Language.ES, this);
        inputDialog.setVisible(true);
        this.setEnabled(false);
    ...
    private void aceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aceptarMouseClicked
        ...
        if (TableEventos.getSelectedColumn() > -1) {
            ...
            if (!g.existeEventoFecha(anno, nombreEvento)) {
                ...
                MessageDialog messageDialog = new MessageDialog("Se ha agregado con éxito el evento \"" + nombreEvento + "\" en el año: " + anno, "Mensaje del sistema",Language.ES, this);
                messageDialog.setVisible(true);
                this.setEnabled(false);
                ...
                MessageDialog messageDialog = new MessageDialog("El evento \"" + nombreEvento + "\" ya existe en el año " + anno, "Mensaje del sistema",Language.ES, this);
                messageDialog.setVisible(true);
                this.setEnabled(false);
            ...
            MessageDialog messageDialog = new MessageDialog("No hay ningún evento seleccionado en la tabla de los nombres de evento", "Mensaje del sistema",Language.ES, this);
                messageDialog.setVisible(true);
                this.setEnabled(false);
