...
public class Evento_estudiante extends AbstractFrame {
    ...
    public Evento_estudiante(Brigada b) {
        ...
        MessageDialog messageDialog = new MessageDialog("Escoja un evento", "",Language.ES, this);
    ...
    private void escogerEventoWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_escogerEventoWindowClosing
        ...
        if (tablaEventos.getSelectedColumn() < 0 && !entrada) {
            ...
            MessageDialog messageDialog = new MessageDialog("Ha cerrado el menú de selección de eventos sin escoger ninguno. Se procederá a abrir la ventana principal", "Error",Language.ES, this);
            messageDialog.setVisible(true);
            this.setEnabled(false);
            Main m = new Main();
            m.setVisible(true);
                ...
                if (fila > -1 && columna == 4) {
                    ...
                    if (!RadioButtonVector.elementAt(fila).isSelected()) {
                        ...
                        if (!logros.isEmpty()) {
                            ...
                            MessageDialog messageDialog = new MessageDialog("Este evento aún no tiene logros. Debe introducir alguno desde la ventana \"Gestor de eventos\"", "",Language.ES, null);
                            messageDialog.setVisible(true);
            ...
            jm.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (indiceLogro < 0) {
                        ...
                        MessageDialog messageDialog = new MessageDialog("No ha seleccionado ningún logro", "",Language.ES, null);
                        messageDialog.setVisible(true);                            
                        return;
                    }
