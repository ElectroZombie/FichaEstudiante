...
public class Editor_carrera extends AbstractFrame {
    ...
    @Override
    public void comboBoxDialog_returnValue(Object O, Object formerO, int seleccion) {
    ...
    private void Annadir_annoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Annadir_annoActionPerformed
        if (Annos.getItemCount() < 6) {
            ...
            MessageDialog messageDialog = new MessageDialog("No se pueden agregar más de 6 años a esta carrera", "Error",Language.ES, this);
    ...
    private void Eliminar_annoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Eliminar_annoActionPerformed
        ...
        if (Annos.getItemCount() <= 1) {
            MessageDialog messageDialog = new MessageDialog("Una carrera debe tener al menos un año. No se puede eliminar el año 1", "Error",Language.ES, this);
            messageDialog.setVisible(true);
            this.setEnabled(false);
            
        } else {
            
            ConfirmDialog confirmDialog = new ConfirmDialog(1, "Si elimina este año de la carrera se perderán junto con él todas las asignaturas del año. ¿Desea proceder?", "",Language.ES, this);
    ...
    private void AgregarAsigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarAsigActionPerformed
        ...
        if (AsignaturaNombre.getText().equals("")) {
            MessageDialog messageDialog = new MessageDialog("No hay escrito un nombre de asignatura en el campo de texto a la derecha de la etiqueta \"Nombre de la asignatura\". Escriba uno para proceder.", "Error",Language.ES, this);
            messageDialog.setVisible(true);
            this.setEnabled(false);
        ...
        if (!Similares.isEmpty()) {
            ...
            ComboBoxDialog inputDialog = new ComboBoxDialog(1, "Existen asignaturas con nombres similares al de la asignatura que ha escrito. Seleccione uno de ellos o pulse en cancelar si no se ha equivocado.", "Sugerencia", S, temp,Language.ES, this);
            ...
            tempGlobal = temp;
            ConfirmDialog confirmDialog = new ConfirmDialog(2, "Se agregará la asignatura a la base de datos. ¿Desea proceder?", "",Language.ES, this);
            confirmDialog.setVisible(true);
            this.setEnabled(false);
