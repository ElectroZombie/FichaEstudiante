...
public class Editor_estudiante extends AbstractFrame {
    ...
    @Override
    public void comboBoxDialog_returnValue(Object O, Object valorInicial, int seleccion) {
    ...
    private void agregarManifestacionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_agregarManifestacionMouseClicked
        ...
        if (manifestacionTexto.getText().equals("")) {
            MessageDialog messageDialog = new MessageDialog("El campo de texto de manifestaciones está vacío", "",Language.ES, this);
        ...
        if (!Similares.isEmpty()) {
            ...
            ComboBoxDialog inputDialog = new ComboBoxDialog(1, "Existen manifestaciones artísticas con nombres similares al de la manifestación que ha escrito. Seleccione uno de ellos o pulse en cancelar si no se ha equivocado.", "Sugerencia", S, temp,Language.ES,this);
            ...
            stringTemporal = temp;
            ConfirmDialog confirmDialog = new ConfirmDialog(1, "Desea añadir esta manifestación a la lista?", "Información", Language.ES,this);
    ...
    private void agregarDeporteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_agregarDeporteMouseClicked
        ...
        if (deporteTexto.getText().equals("")) {
            MessageDialog messageDialog = new MessageDialog("El campo de texto de deportes está vacío", "", Language.ES,this);
            messageDialog.setVisible(true);
            this.setEnabled(false);
        ...
        if (!Similares.isEmpty()) {
            ...
            ComboBoxDialog inputDialog = new ComboBoxDialog(2, "Existen deportes con nombres similares al del deporte que ha escrito. Seleccione uno de ellos o pulse en cancelar si no se ha equivocado.", "Sugerencia", S, temp,Language.ES,this);
            inputDialog.setVisible(true);
            this.setEnabled(false);
            ...
            stringTemporal = temp;
            ConfirmDialog confirmDialog = new ConfirmDialog(2, "Desea añadir este deporte a la lista?", "Información",Language.ES, this);
            confirmDialog.setVisible(true);
            this.setEnabled(false);
        }
    ...
    private void agregarMedicamentoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_agregarMedicamentoMouseClicked
        ...
        if (medicamentoTexto.getText().equals("")) {
            MessageDialog messageDialog = new MessageDialog("El campo de texto de medicamentos está vacío", "",Language.ES, this);
            messageDialog.setVisible(true);
            this.setEnabled(false);
        ...
        if (!Similares.isEmpty()) {
            ...
            ComboBoxDialog inputDialog = new ComboBoxDialog(3, "Existen medicamentos con nombres similares al del medicamento que ha escrito. Seleccione uno de ellos o pulse en cancelar si no se ha equivocado.", "Sugerencia", S, temp,Language.ES,this);
            inputDialog.setVisible(true);
            this.setEnabled(false);
            
        } else {
            stringTemporal = temp;
            ConfirmDialog confirmDialog = new ConfirmDialog(3, "Desea añadir este medicamento a la lista?", "Información",Language.ES, this);
            confirmDialog.setVisible(true);
            this.setEnabled(false);
        }
    ...
    private void agregarEnfermedadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_agregarEnfermedadMouseClicked
        ...
        if (enfermedadTexto.getText().equals("")) {
            MessageDialog messageDialog = new MessageDialog("El campo de texto de enfermedades está vacío", "", Language.ES,this);
            messageDialog.setVisible(true);
            this.setEnabled(false);
        ...
        if (!Similares.isEmpty()) {
            ...
            ComboBoxDialog inputDialog = new ComboBoxDialog(4, "Existen enfermedades con nombres similares al de la enfermedad que ha escrito. Seleccione uno de ellos o pulse en cancelar si no se ha equivocado.", "Sugerencia", S, temp,Language.ES,this);
            inputDialog.setVisible(true);
            this.setEnabled(false);            
            ...
            stringTemporal = temp;
            ConfirmDialog confirmDialog = new ConfirmDialog(4, "Desea añadir esta enfermedad a la lista?", "Información",Language.ES, this);
            confirmDialog.setVisible(true);
            this.setEnabled(false);
    ...
    private void annadirReligionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_annadirReligionActionPerformed
        ...
        if (religionTexto.getText().equals("")) {
            MessageDialog messageDialog = new MessageDialog("El campo de texto de religiones está vacío", "", Language.ES,this);
            messageDialog.setVisible(true);
            this.setEnabled(false);
        ...
        if (!Similares.isEmpty()) {
            ...
            ComboBoxDialog inputDialog = new ComboBoxDialog(5, "Existen religiones con nombres similares al de la religión que ha escrito. Seleccione uno de ellos o pulse en cancelar si no se ha equivocado.", "Sugerencia", S, temp,Language.ES,this);
            inputDialog.setVisible(true);
            this.setEnabled(false);            
            
        } else {
            
            ConfirmDialog confirmDialog = new ConfirmDialog(5, "Desea añadir esta religion a la lista?", "Información", Language.ES,this);
            confirmDialog.setVisible(true);
            this.setEnabled(false);
            }
        religionTexto.setEnabled(false);
    ...
    private void editarNotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editarNotaMouseClicked
        ...
        ComboBoxDialog inputDialog = new ComboBoxDialog(6, "Selecciona la nota del estudiante", "Sugerencia", posiblesNotas, "", Language.ES,this);
        inputDialog.setVisible(true);
        this.setEnabled(false);
    ...
    private void finalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finalizarActionPerformed
        ...
        if (MB.contains("0")) {
            ...
            MessageDialog messageDialog = new MessageDialog(S, "Error", Language.ES,this);
            messageDialog.setVisible(true);
        ...
        if (nombre.length <= 2) {
            MessageDialog messageDialog = new MessageDialog("El nombre completo del estudiante es incorrecto, pues debe tener al menos dos apellidos", "Error", Language.ES,this);
            messageDialog.setVisible(true);
            this.setVisible(true);            
            return;
        }
        if (!Secuencias_cadenas.carnetIdentidadCorrecto(carnetTexto.getText())) {
            MessageDialog messageDialog = new MessageDialog("El carnet de identidad del estudiante es incorrecto", "Error", Language.ES,this);
            messageDialog.setVisible(true);
            this.setVisible(true);            
            return;
        }
        if (Integer.parseInt(edadT.getText()) <= 15) {
            MessageDialog messageDialog = new MessageDialog("La edad del estudiante es incorrecta. Debe ser mayor de 15 años", "Error", Language.ES,this);
            messageDialog.setVisible(true);
            this.setVisible(true);            
            return;
        }
